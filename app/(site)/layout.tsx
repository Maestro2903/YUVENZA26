...
// These load ONLY for the public site - the admin panel lives in the
// app/(admin) route group with its own root layout and stylesheet.
import "../webflow.css";
import "../globals.css";
  ...
  return (
    <html lang="en">
      <body className="body">
        ...
        <SiteScripts />
        {/* Vercel Analytics + Speed Insights: no-ops outside Vercel production */}
        <Analytics />
        <SpeedInsights />
      </body>
    </html>
